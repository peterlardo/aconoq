<?php $pageTitle = 'Mot du Directeur Général'; ?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <main class="norm-page">
        <div class="norm-container">
            <div class="flex items-center justify-between mb-8">
                ...
                <p class="text-sm"><a href="index.php" class="text-primary hover:underline">Accueil</a> <span class="mx-1 text-gray-400">/</span> <span class="text-dark font-medium">Directeur Général</span></p>
            </div>
            <article class="norm-card">
                <div style="margin:-42px -42px 28px;border-radius:18px 18px 0 0;overflow:hidden;height:150px">
                    <img src="images/header-directeur.jpg" alt="Mot du Directeur Général" style="width:100%;height:100%;object-fit:cover">
                </div>
                <p class="section-tag">ACONOQ</p>
                <h1><strong>Mot</strong> du <em>Directeur Général</em></h1>
