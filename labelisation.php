    ...
    <main class="norm-page">
        <div class="norm-container">
            <div class="flex items-center justify-between mb-8">
                ...
                <p class="text-sm"><a href="index.php" class="text-primary hover:underline">Accueil</a> <span class="mx-1 text-gray-400">/</span> <span class="text-dark font-medium">Labelisation</span></p>
            </div>
            <article class="norm-card">
                <div style="margin:-42px -42px 28px;border-radius:18px 18px 0 0;overflow:hidden;height:200px">
                    <img src="images/header-labelisation.jpg" alt="Labelisation" style="width:100%;height:100%;object-fit:cover">
                </div>
                <p class="section-tag">Service</p>
                <h1><strong>Labelisation</strong></h1>

                <div class="norm-callout">
                    <strong>Attribution de labels et marques nationales de conformité aux normes.</strong>
                </div>

                <h2>Qu'est-ce que la labelisation ?</h2>
                <p>La labelisation est un processus par lequel un organisme compétent attribue un label à un produit, un procédé ou un service qui répond à des critères de qualité supérieurs aux exigences normatives courantes. Le label est un gage de qualité et de confiance pour les consommateurs.</p>

                <h2>Nos prestations de labelisation</h2>
                <ul class="service-list">
                    <li>Attribution du label NCGO aux produits de qualité</li>
                    <li>Label de conformité pour les produits agricoles</li>
                    <li>Label de qualité pour les services</li>
                    <li>Suivi et contrôle des produits labellisés</li>
                    <li>Renouvellement des labels</li>
                </ul>

                <h2>Avantages du label NCGO</h2>
                <p>Le label NCGO permet aux produits de se distinguer sur le marché congolais et international. Il garantit aux consommateurs que le produit répond à des critères de qualité stricts et contrôlés par l'ACONOQ.</p>
