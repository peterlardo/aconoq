    ...
    <main class="norm-page">
        <div class="norm-container">
            <div class="flex items-center justify-between mb-8">
                ...
                <p class="text-sm"><a href="index.php" class="text-primary hover:underline">Accueil</a> <span class="mx-1 text-gray-400">/</span> <span class="text-dark font-medium">PCEC</span></p>
            </div>
            <article class="norm-card">
                <div style="margin:-42px -42px 28px;border-radius:18px 18px 0 0;overflow:hidden;height:150px">
                    <img src="images/header-pcec.jpg" alt="PCEC" style="width:100%;height:100%;object-fit:cover">
                </div>
                <p class="section-tag">Programmes</p>
                <h1><strong>Programme</strong> Congolais d'Évaluation de la <em>Conformité</em></h1>
