<?php $pageTitle = 'Formulaire de demande de formation'; ?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <main class="norm-page">
        <div class="norm-container">
            <div class="flex items-center justify-between mb-8">
                ...
                <p class="text-sm"><a href="index.php" class="text-primary hover:underline">Accueil</a> <span class="mx-1 text-gray-400">/</span> <span class="text-dark font-medium">Formulaire de demande de formation</span></p>
            </div>
            <article class="norm-card">
                <p class="section-tag">Promotion de la qualité | Formulaires</p>
                <h1><strong>Formulaire de demande de</strong> <em>formation</em></h1>
            </article>
        </div>
    </main>
